...
dataSet[dataSetVersion].characterData = [
    {
        name: "Endro~!",
        img: "https://cdn.myanimelist.net/images/anime/1475/96180l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    },
    {
        ...
        img: "https://cdn.myanimelist.net/images/anime/1778/100470l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Kaguya-Sama",
        img: "https://cdn.myanimelist.net/images/anime/1291/97023l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    },
    {
        ...
        img: "https://cdn.myanimelist.net/images/anime/1125/96929l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Dororo",
        img: "https://cdn.myanimelist.net/images/anime/1879/100467l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Kemurikusa",
        img: "https://cdn.myanimelist.net/images/anime/1254/100472l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    },
    {
        ...
        img: "https://cdn.myanimelist.net/images/anime/1819/97947l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Sarazanmai",
        img: "https://cdn.myanimelist.net/images/anime/1159/100455l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    },
    {
        ...
        img: "https://cdn.myanimelist.net/images/anime/1130/99458l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    },
    {
        ...
        img: "https://cdn.myanimelist.net/images/anime/1602/100510l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Carole & Tuesday",
        img: "https://cdn.myanimelist.net/images/anime/1611/96157l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "JoJo Bizarre Adventure Part 5: Ougon no Kaze",
        img: "https://cdn.myanimelist.net/images/anime/1572/95010l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    },
    {
        ...
        img: "https://cdn.myanimelist.net/images/anime/1395/101109l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Granbelm",
        img: "https://cdn.myanimelist.net/images/anime/1035/101330l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    },
    {
        ...
        img: "https://cdn.myanimelist.net/images/anime/1227/99966l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    },
    {
        ...
        img: "https://cdn.myanimelist.net/images/anime/1256/101166l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Symphogear XV",
        img: "https://cdn.myanimelist.net/images/anime/1899/101966l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Vinland Saga",
        img: "https://cdn.myanimelist.net/images/anime/1048/102249l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Beastars",
        img: "https://cdn.myanimelist.net/images/anime/1234/102008l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    },
    {
        ...
        img: "https://cdn.myanimelist.net/images/anime/1858/102811l.jpg",
        opts: {
            in2019: ["anime"],
            in2018: []
        }
    ...
    {
        name: "Shirosaki Hana - Wataten",
        img: "src/assets/aoty19/girl/shirosaki hana-wataten.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Raphtalia - Tate no Yuusha no Nariagari",
        img: "src/assets/aoty19/girl/raphtalia-tateyuusha.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    },
    {
        ...
        img: "src/assets/aoty19/girl/fujiwara chika-kaguya sama.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Hoshino Miyako (Mya-nee) - wataten",
        img: "src/assets/aoty19/girl/hoshino miyako-wataten.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Nakano Nino - 5toubun no Hanayome",
        img: "src/assets/aoty19/girl/nakano nino - 5toubun.png",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Nakano Yotsuba - 5toubun no Hanayome",
        img: "src/assets/aoty19/girl/nakano yotsuba-5toubun.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Yulia Chardiet(Yuusha) - Endro",
        img: "src/assets/aoty19/girl/yulia chardiet - endro.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Honshou Aru - Hitoribocchi no Marumaru Seikatsu",
        img: "src/assets/aoty19/girl/honshou aru - hitoribocchi.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Yukishiro, Nanako - Senryuu Shoujo",
        img: "src/assets/aoty19/girl/yukishiro nanako- senryuu shojo.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Horie Ao - Midara na Ao-chan wa Benkyou ga Dekinai",
        img: "src/assets/aoty19/girl/horie ao - aochan.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Furuhashi Fumino - Bokuben",
        img: "src/assets/aoty19/girl/furuhashi fumino-bokuben.jpeg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    },
    {
        ...
        img: "src/assets/aoty19/girl/nezuko-kimetsu no yaiba.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Yuuko Yoshida - Machikado Mazoku",
        img: "src/assets/aoty19/girl/yukko yoshida - machikado mazoku.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Sugawara Niina - Araburu Kisetsu no Otome-domo yo",
        img: "src/assets/aoty19/girl/sugawara niina - araburu.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Chiyoda Momo - Machikado Mazoku",
        img: "src/assets/aoty19/girl/chiyoda momo - machikado mazoku.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Onishima Homare - Sounan desu ka?",
        img: "src/assets/aoty19/girl/onishima homare-sounan desuka.png",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Hibiki Tachibana - Symphogear XV",
        img: "src/assets/aoty19/girl/hibiki tachibana - symphogear.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Mile/Adele/Kurihara Misato - Noukin",
        img: "src/assets/aoty19/girl/mile-noukin.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Shibusawa Izumi - Rifle Is Beautiful",
        img: "src/assets/aoty19/girl/shibuzawa izumi-rifle is beautiful.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Mitsue Kanako - Hoshiai no Sora",
        img: "src/assets/aoty19/girl/mitsue kanako - hoshiai no sora.jpg",
        opts: {
            in2019: ["girl"],
            in2018: []
        }
    ...
    {
        name: "Naofumi Iwatani - Tate no Yuusha no Nariagari",
        img: "src/assets/aoty19/boy/naofumi iwatani - tate yuusha.png",
        opts: {
            in2019: ["boy"],
            in2018: []
        }
    ...
    {
        name: "Wakaba - Kemurikusa",
        img: "src/assets/aoty19/boy/wakaba - kemurikusa.jpg",
        opts: {
            in2019: ["boy"],
            in2018: []
        }
    ...
    {
        name: "Hyakkimaru - Dororo",
        img: "src/assets/aoty19/boy/Hyakkimaru-dororo.png",
        opts: {
            in2019: ["boy"],
            in2018: []
        }
    ...
    {
        name: "Norman - Yakusoku no Neverland",
        img: "src/assets/aoty19/boy/norman - yakusoku-no-neverland.jpg",
        opts: {
            in2019: ["boy"],
            in2018: []
        }
    ...
    {
        name: "Ishigami Yuu - Kaguya-sama Love is War",
        img: "src/assets/aoty19/boy/ishigami yuu-kaguya sama.jpg",
        opts: {
            in2019: ["boy"],
            in2018: []
        }
    ...
    {
        name: "Shiogane Miyuki - Kaguya-sama Love is War",
        img: "src/assets/aoty19/boy/shirogane miyuki - kaguya sama.jpg",
        opts: {
            in2019: ["boy"],
            in2018: []
        }
    ...
    {
        name: "Yasaka, Kazuki - Sarazanmai",
        img: "src/assets/aoty19/boy/yasaka kazuki-sarazanmai.jpg",
        opts: {
            in2019: ["boy"],
            in2018: []
        }
    },
    {
        ...
        img: "src/assets/aoty19/boy/askeladd-vinland saga.jpg",
        opts: {
            in2019: ["boy"],
            in2018: []
        }
    ...
    {
        name: "Waseda - Joshimuda",
        img: "src/assets/aoty19/boy/waseda-joshimuda.jpg",
        opts: {
            in2019: ["boy"],
            in2018: []
        }
    ...
    {
        name: "Mao-Sensei - Endro",
        img: "src/assets/aoty19/supp/mao sensei-endro.jpg",
        opts: {
            in2019: ["supp"],
            in2018: []
        }
    ...
    {
        name: "Melty Q Melromarc - Tate no Yuusha no Nariagari",
        img: "src/assets/aoty19/supp/melty.jpg",
        opts: {
            in2019: ["supp"],
            in2018: []
        }
    ...
    {
        name: "Ootsuki, Koto - Senryuu Shoujo",
        img: "src/assets/aoty19/supp/Ootsuki, Koto - Senryuu Shoujo.jpg",
        opts: {
            in2019: ["supp"],
            in2018: []
        }
    ...
    {
        name: "Kurai Kako - Hitoribocchi no Marumaru Seikatsu",
        img: "src/assets/aoty19/supp/kurai.jpg",
        opts: {
            in2019: ["supp"],
            in2018: []
        }
    ...
    {
        name: "Roddy - Carole and Tuesday",
        img: "src/assets/aoty19/supp/rody - carole & tuesday.jpg",
        opts: {
            in2019: ["supp"],
            in2018: []
        }
    ...
    {
        name: "Saku Momoi (Rori) - Joshikousei no Mudazukai",
        img: "src/assets/aoty19/supp/saku momoi(rori) - joshimuda.jpg",
        opts: {
            in2019: ["supp"],
            in2018: []
        }
    ...
    {
        name: "Koharu Ootori - Kawaikereba Hentai demo Suki ni Natte Kuremasu ka?",
        img: "src/assets/aoty19/supp/koharu ootori - hensuki.jpg",
        opts: {
            in2019: ["supp"],
            in2018: []
        }
    ...
    {
        name: "Ninomae Kanade (Majime) - Joshikousei no Mudazukai",
        img: "src/assets/aoty19/supp/ninomae kanade-joshumuda.jpg",
        opts: {
            in2019: ["supp"],
            in2018: []
        }
